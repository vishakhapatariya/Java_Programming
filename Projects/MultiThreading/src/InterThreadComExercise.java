// Inter-Thread Communication Exercise
// Teacher class will write in a whiteboard and multiple Students(Thread) class will read that from the whiteboard
class WhiteBoard
{
    String text;
...
public class InterThreadComExercise
{
